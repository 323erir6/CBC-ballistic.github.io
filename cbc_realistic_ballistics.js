...
function rocketMotorProfile(c,id){if(c==="cbc_at_rocket_pod"&&/^cbc_at:(?:ap|flak|he|hei)_rocket$/.test(id))return{step:.025,max:2.5};if(c==="cbc_at_medium_rocket_rail"&&/^cbc_at:medium_.*_rocket$/.test(id))return{step:.05,max:3.75};if(c==="cbcatfix_big_rocket_rail"&&/^cbcatfix:big_.*_rocket$/.test(id))return{step:.138,max:1.242};return null}
